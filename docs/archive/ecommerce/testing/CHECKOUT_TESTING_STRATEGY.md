...
> Archivo historico: describe una estrategia centrada en checkout, pagos y webhooks retirados del arbol ejecutable principal. La estrategia vigente esta en [`../../../TESTING_STRATEGY.md`](../../../TESTING_STRATEGY.md).
